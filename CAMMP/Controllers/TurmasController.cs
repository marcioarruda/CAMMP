...
namespace CAMMP.Controllers
{
    public class TurmasController : Controller
    {
        ...
        public TurmasController(CAMMPContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Turma turma)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Turma turma)
        {
            if (id != turma.Id)
            {
                return NotFound();
